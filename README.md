# VRS-Operator-Flags ✈️ [![MIT License](https://img.shields.io/badge/License-MIT-red.svg)](LICENSE) [![VRS version 2.4](https://img.shields.io/badge/VRS-v2.4-blue.svg)](http://virtualradarserver.co.uk/Download.aspx) [![Build Status](https://travis-ci.org/dedevillela/VRS-Operator-Flags.svg?branch=master)](https://travis-ci.org/dedevillela/VRS-Operator-Flags) [![GitHub release](https://img.shields.io/github/release/dedevillela/VRS-Operator-Flags.svg)](https://github.com/dedevillela/VRS-Operator-Flags/releases) [![bitHound Code](https://www.bithound.io/github/dedevillela/VRS-Operator-Flags/badges/code.svg)](https://www.bithound.io/github/dedevillela/VRS-Operator-Flags) [![bitHound Overall Score](https://www.bithound.io/github/dedevillela/VRS-Operator-Flags/badges/score.svg)](https://www.bithound.io/github/dedevillela/VRS-Operator-Flags)
